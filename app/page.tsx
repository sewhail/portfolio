...
export default function Page() {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-2 sm:py-3">
          <nav className="flex items-center justify-between">
            ...
            <Button
              ...
              size="sm"
              onClick={toggleTheme}
              className={`h-6 w-6 p-0 rounded-none transition-all duration-200 hover:scale-110 active:scale-95 ${isDark ? 'hover:bg-gray-800' : 'hover:bg-gray-100'}`}
            >
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        >
          <div className={`mb-6 transition-all duration-500 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
            <h1 className={`text-xs sm:text-sm font-light mb-1 ${isDark ? 'text-gray-200' : 'text-gray-900'}`}>$ whoami</h1>
            <p className={`text-[10px] sm:text-xs font-light ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>suhail@portfolio:~</p>
          </div>

          <p className={`text-[11px] sm:text-xs leading-relaxed mb-4 max-w-xl font-light transition-all duration-500 delay-100 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'} ${isDark ? 'text-gray-400' : 'text-gray-700'}`}>
          ...
          <div className={`flex items-center gap-1.5 sm:gap-2 transition-all duration-500 delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
            ...
            <Button
              variant="ghost"
              size="sm"
              className={`h-5 text-[9px] sm:text-[10px] px-1.5 sm:px-2 rounded-none font-light transition-all duration-200 hover:scale-105 active:scale-95 ${isDark ? 'hover:bg-gray-800' : 'hover:bg-gray-100'}`}
              asChild
            >
            ...
            <Button
              variant="ghost"
              size="sm"
              className={`h-5 text-[9px] sm:text-[10px] px-1.5 sm:px-2 rounded-none font-light ${isDark ? 'hover:bg-gray-800' : 'hover:bg-gray-100'}`}
              asChild
            >
        ...
        <section id="current" className="mb-16 sm:mb-20">
          <div className="flex items-center gap-2 mb-5">
            <span className={`text-[10px] ${isDark ? 'text-green-400' : 'text-green-500'}`}>●</span>
            <h2 className={`text-[11px] sm:text-xs font-light tracking-wider ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>/current</h2>
          </div>
          ...
          <div className="space-y-1.5">
            {[
              ...
              <div
                key={index}
                className={`flex items-start gap-2 px-2 py-1.5 sm:py-1 transition-all duration-300 ease-out hover:translate-x-2 hover:scale-[1.02] active:scale-[0.98] hover:bg-opacity-100 cursor-pointer group ${isDark ? 'hover:bg-gray-800/40' : 'hover:bg-gray-100/40'
                  }`}
                style={{ transitionDelay: `${index * 50}ms` }}
              >
                <span className={`text-[9px] sm:text-[10px] font-light transition-colors duration-300 ${isDark ? 'text-gray-600 group-hover:text-gray-500' : 'text-gray-400 group-hover:text-gray-500'}`}>{item.prefix}</span>
                <span className={`text-[9px] sm:text-[10px] font-light transition-colors duration-300 ${isDark ? 'text-gray-400 group-hover:text-gray-300' : 'text-gray-600 group-hover:text-gray-700'}`}>{item.text}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-16 sm:mb-20">
          <h2 className={`text-[11px] sm:text-xs font-light tracking-wider mb-5 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>/skills</h2>
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-1.5 sm:gap-2">
            {['js', 'py', 'react', 'node', 'ts', 'psql', 'docker', 'aws'].map((skill, index) => (
              ...
              >
                <span className={`text-[8px] sm:text-[9px] font-light ${isDark ? 'text-gray-500' : 'text-gray-600'}`}>{skill}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="contact" className="mb-16">
          <h2 className={`text-[11px] sm:text-xs font-light tracking-wider mb-5 ${isDark ? 'text-gray-200' : 'text-gray-800'}`}>/contact</h2>

          <Card className={`border ${isDark ? 'border-gray-800 bg-gray-900/30' : 'border-gray-300 bg-gray-50/40'}`}>
            <CardContent className="p-3 sm:p-4">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <div className="flex items-center gap-1">
                  ...
                  <a href="mailto:sxhail@outlook.in" className={`text-[9px] sm:text-[10px] font-light hover:underline ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    sxhail@outlook.in
                  </a>
                </div>
      ...
      {/* Footer */}
      <footer className={`border-t mt-20 ${isDark ? 'border-gray-800' : 'border-gray-300'}`}>
